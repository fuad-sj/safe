...
public interface GeoQueryEventListener {
     ...
     */
    void onKeyEntered(String key, GeoLocation location, DataSnapshot snapshot);
     ...
     * @param location The location for this key as a GeoLocation object
     */
    void onKeyMoved(String key, GeoLocation location, DataSnapshot snapshot);

    /**
     * Called if the data snapshot at a key changed
     *
     * This method can be called multiple times.
     *
     * @param key The key that moved within the search area
     * @param location The location for this key as a GeoLocation object
     */
    void onKeyChanged(String key, GeoLocation location, DataSnapshot snapshot);
